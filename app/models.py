...
class Comment(db.Model):
    ...
    #     kwargs['target'].body_html = bleach.linkify(bleach.clean(markdown(kwargs['value'], output_format='html'),
    #                                                              tags=allowed_tags, strip=True))
...
# named=True才可以使用关键字传参
# db.event.listen(Comment.body, 'set', Comment.on_change_body, named=True)
